...
CREATE VIEW vMainSchedule (insititute, education_ourse, education_form, day, pair, pair_start, pair_end, subject_1, subject_2, lecture_hall)
  AS SELECT g.id_institute,
